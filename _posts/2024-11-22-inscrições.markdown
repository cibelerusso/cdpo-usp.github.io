...
<p style='text-align: justify;text-justify: inter-word;'>
    Todos os documentos solicitados pelo sistema Apolo são obrigatórios, exceto o "Documento específico". Este campo é opcional para o caso de você desejar incluir mais informações que achar relevantes. Veja a lista completa dos documentos a seguir:
    <ol>
        ...
        <li>Histórico escolar de graduação</li>
        <li>Currículo</li>

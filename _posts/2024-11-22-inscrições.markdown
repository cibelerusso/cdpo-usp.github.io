...
<p style='text-align: justify;text-justify: inter-word;'>
    Todos os documentos solicitados pelo sistema Apolo são obrigatórios, exceto o "Documento específico" e o "Histórico escolar de graduação". O documento específico é opcional para o caso de você desejar incluir mais informações que achar relevantes e o histórico serve para auxiliar na classificação e ajuda a conhecer melhor a formação das/dos alunas/alunos. Veja a lista completa dos documentos a seguir:
    <ol>

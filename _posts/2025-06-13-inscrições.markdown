...
<p style='text-align: justify;text-justify: inter-word;'>
    ...
    <br><br>
    As inscrições deverão ser feitas entre os dias 26/06/2025 e 10/08/2025. Links e mais instruções para inscrição serão divulgados oportunamente.
...
<p style='text-align: justify;text-justify: inter-word;'>
    ...
    Os pagamentos podem ser realizados por crédito via pix em conta a ser informada oportunamente, ou por boleto (precisaremos de nome completo, endereço completo, CPF, RG, email).
</p>
...
<p style='text-align: justify;text-justify: inter-word;'>
    A solicitação de bolsa deve ser feita até dia 20/07/2025 através do preenchimento do formulário que será divulgado oportunamente.
     <!-- pode ser encontrado abaixo:<br>
